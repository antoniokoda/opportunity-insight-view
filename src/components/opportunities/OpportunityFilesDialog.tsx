...
export const OpportunityFilesDialog: React.FC<OpportunityFilesDialogProps> = ({
  ...
  const { files, isLoading, uploadFile, deleteFile, downloadFile, isUploading, isDeleting } = useOpportunityFiles(opportunityId);
                  ...
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <span>•</span>
                        <span>{format(new Date(file.created_at), 'dd/MM/yyyy HH:mm', { locale: es })}</span>
                      </div>
                    </div>
                  </div>
